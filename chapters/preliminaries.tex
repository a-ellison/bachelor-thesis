...
\begin{itemize}
	...
	\item When will stick to using $\kappa$ as the security parameter of a private-key encryption scheme and $\eta$ as the parameter of a public-key encryption scheme
