...
\newcommand{\teav}{t_\mathrm{EAV}}
\newcommand{\eeav}{\epsilon_\mathrm{EAV}}
\newcommand{\tddh}{t_\mathrm{DDH}}
...
% games and advantage
\newcommand{\game}[3][\mathchal{A}]{\mathrm{Game}_{#1, #2}^{\mathrm{#3}}}
\newcommand{\advantage}[3][\mathcal{A}]{\mathrm{Adv}_{#1, #2}^{\mathrm{#3}}}
